...
<div style=\"font-family: system-ui, sans-serif, Arial; font-size: 14px; max-width: 600px; margin: 0 auto;\">
  ...
  <div style=\"padding: 20px 0;\">
    <p style=\"padding-top: 14px; border-top: 1px solid #eaeaea; margin-top: 20px;\">
      Спасибо за интерес к AI Tracking! Ваш промокод на 1 бесплатный анализ готов:
    </p>
    ...
    <div style=\"background: #fff; border: 1px solid #eaeaea; padding: 20px; border-radius: 8px; margin: 20px 0;\">
      ...
      <ul style=\"color: #666; line-height: 1.6;\">
        <li>1 полный анализ любого дизайна</li>
        <li>Детальный отчет с рекомендациями</li>
    ...
    <p style=\"color: #666;\">
      Используйте промокод при регистрации на нашем сайте для получения 1 бесплатного AI-анализа дизайна.<br />
      Анализируйте интерфейсы, рекламные креативы, лендинги и получайте детальный отчет с рекомендациями.
    </p>
...
Спасибо за интерес к AI Tracking! Ваш промокод на 1 бесплатный анализ: {$promo_code}

Промокод действителен до: {$expiry_date}

Что вы получаете:
• 1 полный анализ любого дизайна  
...
4. Загрузите свой дизайн для анализа
  ...
  <div style=\"padding: 20px 0;\">
    ...
    <div style=\"background: #fff; border: 1px solid #eaeaea; padding: 20px; border-radius: 8px; margin: 20px 0;\">
      ...
      <p style=\"color: #666; line-height: 1.6; margin: 0;\">
        Клиент получил письмо с промокодом <strong>{$promo_code}</strong> на 1 бесплатный анализ. 
        Промокод действителен до {$expiry_date}.
      </p>
    </div>
...
Что получил клиент:
Клиент получил письмо с промокодом {$promo_code} на 1 бесплатный анализ.
Промокод действителен до {$expiry_date}.
